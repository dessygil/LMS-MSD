...
3. Start the server with `python manage.py runserver 8000`
4. Try calling [http://api.localhost:8000/api/public](http://api.localhost:8000/api/public)

# Testing the API

You can then try to do a GET to [http://api.localhost:8000/api/private](http://api.localhost:8000/api/private) which will
...
[http://api.localhost:8000/api/private-scoped/](http://api.localhost:8000/api/private-scoped) which will throw an error if
...
2. Try calling [http://api.localhost:8000/api/public](http://api.localhost:8000/api/public)
